...
//#region ../store/docs/examples/tanstack-query-fat-store.md
var frontmatter = { "description": "A checkout flow split along ownership lines: one withPlugins store for what the client owns (cart, step, promo code), TanStack Query for what the server owns." };
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.h1, {
			id: "tanstack-query-and-one-fat-store",
			children: [jsx(_components.a, {
				className: "header-anchor",
				"aria-label": "Permalink to \"TanStack Query and One Fat Store\"",
				href: "#tanstack-query-and-one-fat-store",
		...
		jsxs(_components.p, { children: [
			...
			" owns (cart contents, current step, draft promo code), TanStack\nQuery holds what the ",
			jsx(_components.em, { children: "server" }),
			" owns (catalog, stock, computed pricing, order\nhistory). This variant keeps the client half as one ",
			...
			"\nfor the same app built the other way, one ",
			jsx(_components.code, { children: "createStore" }),
			" per field. Full source\nin\n",
			jsx(_components.a, {
				href: "https://github.com/kintools-dev/store/tree/main/examples/checkout-redux-style-react-query",
				children: jsx(_components.code, { children: "examples/checkout-redux-style-react-query" })
			}),
			"."
		] }),
		"\n",
		...
		"\n",
		jsxs(_components.h2, {
			id: "feeding-a-store-selection-into-a-query-key",
			children: [jsx(_components.a, {
				className: "header-anchor",
				"aria-label": "Permalink to \"Feeding a store selection into a query key\"",
				href: "#feeding-a-store-selection-into-a-query-key",
				children: jsx(_components.span, {
					"aria-hidden": "true",
					children: "#"
				})
					...
					children: [
						...
						jsx(_components.span, {
							...
							children: jsx(_components.span, {
								...
								children: "      // Client state moves to \"confirmation\" and forgets the cart."
							})
						}),
						"\n",
						jsxs(_components.span, {
		...
		"\n",
		jsxs(_components.h2, {
			id: "driving-the-ui-off-the-store",
			children: [jsx(_components.a, {
				className: "header-anchor",
				"aria-label": "Permalink to \"Driving the UI off the store\"",
				href: "#driving-the-ui-off-the-store",
				children: jsx(_components.span, {
					"aria-hidden": "true",
					children: "#"
				})
		...
		jsxs(_components.p, { children: [
			...
			" selection is what decides which panel renders — no router,\nno separate page per step:"
		] }),
		"\n",
		jsx(_components.figure, {
			"data-rehype-pretty-code-figure": "",
					...
					children: [
						...
						jsxs(_components.span, {
							...
							children: [
								...
								jsx(_components.span, {
									style: { "--shiki-light": "#9A5B13" },
									children: "./components/ProductCatalog.tsx"
								}),
								jsx(_components.span, {
									style: { "--shiki-light": "#3C4257" },
									children: "\""
						...
						jsxs(_components.span, {
							...
							children: [
								...
								jsx(_components.span, {
									style: { "--shiki-light": "#9A5B13" },
									children: "./components/CartPanel.tsx"
								}),
								jsx(_components.span, {
									style: { "--shiki-light": "#3C4257" },
									children: "\""
						...
						jsxs(_components.span, {
							...
							children: [
								...
								jsx(_components.span, {
									style: { "--shiki-light": "#9A5B13" },
									children: "./components/CheckoutForm.tsx"
								}),
								jsx(_components.span, {
									style: { "--shiki-light": "#3C4257" },
									children: "\""
						...
						jsxs(_components.span, {
							...
							children: [
								...
								jsx(_components.span, {
									style: { "--shiki-light": "#9A5B13" },
									children: "./components/Confirmation.tsx"
								}),
								jsx(_components.span, {
									style: { "--shiki-light": "#3C4257" },
									children: "\""
