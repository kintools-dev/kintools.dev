...
//#region ../form/docs/guide/dynamic-arrays.md
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.h1, {
			...
			children: [jsx(_components.a, {
				...
				"aria-label": "Permalink to \"Dynamic Arrays\"",
				href: "#dynamic-arrays",
		...
		jsxs(_components.p, { children: [
			...
			" exchanges only the two given indices; everything between stays\nuntouched. ",
			jsx(_components.code, { children: "moveItem" }),
			" shifts every item strictly between ",
			jsx(_components.code, { children: "fromIndex" }),
			" and\n",
			jsx(_components.code, { children: "toIndex" }),
			" one slot over, the same result as splicing the item out and\nre-inserting it elsewhere. ",
			jsx(_components.code, { children: "removeItem" }),
			" unregisters the removed item's field(s)\nfirst, so they don't leak."
		] }),
		"\n",
		jsxs(_components.h2, {
			id: "addressing-the-nodes-own-value",
			children: [jsx(_components.a, {
				className: "header-anchor",
				"aria-label": "Permalink to \"Addressing the node's own value\"",
				href: "#addressing-the-nodes-own-value",
				children: jsx(_components.span, {
					"aria-hidden": "true",
					children: "#"
				})
		...
		"\n",
		jsxs(_components.p, { children: [
			"Every array method also accepts ",
			jsx(_components.code, { children: "\"\"" }),
			" for ",
			jsx(_components.code, { children: "name" }),
			", addressing ",
			jsx(_components.strong, { children: "the node's own\nvalue" }),
			", for a reusable component that receives a\n",
			jsx(_components.code, { children: "FieldApi<Item[], TParentValue>" }),
			" and shouldn't need the dotted path to it:"
		] }),
		"\n",
		...
		"\n",
		jsxs(_components.h2, {
			id: "why-re-keying-matters",
			children: [jsx(_components.a, {
				className: "header-anchor",
				"aria-label": "Permalink to \"Why re-keying matters\"",
				href: "#why-re-keying-matters",
				children: jsx(_components.span, {
					"aria-hidden": "true",
					children: "#"
				})
		...
		jsxs(_components.p, { children: [
			...
			" (see ",
			jsx(_components.a, {
				href: "/form/guide/concepts#shared-state",
				children: "Concepts"
			}),
			") stays\nstable across a reorder even as ",
			jsx(_components.code, { children: "name" }),
			" (the index-based path) changes: it's the\nright list key (",
